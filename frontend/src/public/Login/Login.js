...
function Login() {
    ...
    return (
        <main>
            <section className="vh-lg-100 nt-5 nt-lg-0 bg-soft d-flex align-itens-center">
                            ...
                            <form action="#" className="mt-4" onSubmit={onSubmit}>
                                <div className="form-group mb-4">
                                    ...
                                    <div className="input-group">
                                        ...
                                        <input type="email" className="form-control" placeholder="exemplo@gmail.com" id="email" autofocus required onChange={onChangeInput} />
                                    </div> 
                                    <div className="form-group">
                                        <div className="form-group mb-4">
                                            <label for="password">Sua Senha Aqui</label>
                                            <div className="input-group">
